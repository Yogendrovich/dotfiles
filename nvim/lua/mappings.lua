...
set_keymap('n', '<leader>k', '<c-w>j')
set_keymap('n', '<leader>j', '<c-w>k')
set_keymap('n', '<leader>i', '<c-w>h')
...
-- LSP
set_keymap('n', '<leader>d', '<cmd>lua vim.lsp.buf.definition()<cr>')
set_keymap('n', '<leader>D', '<cmd>lua vim.lsp.buf.declaration()<cr>')
set_keymap('n', '<leader>t', '<cmd>lua vim.lsp.buf.type_definition()<cr>')
set_keymap('n', '<leader>i', '<cmd>lua vim.lsp.buf.implementation()<cr>')
set_keymap('n', 'K', '<cmd>lua vim.lsp.buf.hover()<cr>')
set_keymap('n', 'H', '<cmd>lua vim.lsp.buf.signature_help()<cr>')
set_keymap('n', '<leader>r', '<cmd>lua vim.lsp.buf.references()<cr>')
set_keymap('n', '<leader>s', '<cmd>lua vim.lsp.buf.document_symbol()<cr>')
set_keymap('n', '<leader>S', '<cmd>lua vim.lsp.buf.workspace_symbol()<cr>')
